...
const CampfireAbout = ({ campfire, setDrawerOpen }: CampfireAboutProps) => {
  ...
  return (
    <div className="flex items-start flex-col pt-4 pb-16 md:py-4 gap-4 bg-neutral-100 dark:bg-neutral-800 rounded-lg text-sm text-neutral-500 dark:text-neutral-300">
      ...
      <div className="flex items-start flex-col gap-4 px-4 py-2 w-full">
        ...
        <Button
          ...
          variant={"outline"}
          className={
            "w-full items-center  h-8 bg-neutral-200 hover:bg-neutral-100 dark:bg-neutral-900 dark:hover:bg-neutral-800  text-black dark:text-white border border-neutral-300 dark:border-neutral-600 rounded-full"
          }
