 ...
 */
export function ManageCampfireCardDemo() {
  ...
  return (
    <div className="container mx-auto max-w-4xl p-4 md:p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Manage Campfires</h1>
        <p className="text-muted-foreground">
          Join campfires, mark your favorites, and stay connected with your
          communities
        </p>
      </div>
